...
export const COLOMBIA: Record<string, string[]> = {
  ...
  'Antioquia': [
    ...
    'Nariño', 'Nechí', 'Necoclí', 'Olaya', 'Peque', 'Puerto Berrío',
    ...
    'Santo Domingo', 'Segovia', 'Sonsón', 'Sopetrán', 'Tarazá', 'Tarso',
  ...
  'Bolívar': [
    ...
    'Montecristo', 'Morales', 'Mompox', 'Norosí', 'Pinillos', 'Regidor',
  ...
  'Boyacá': [
    ...
    'Tota', 'Tununguá', 'Tunja', 'Turmequé', 'Tuta', 'Tutazá', 'Umbita',
  ...
  'Caldas': [
    ...
    'Pensilvania', 'Risaralda', 'Riosucio', 'Salamina', 'Samaná', 'San José',
  ...
  'Cundinamarca': [
    ...
    'Tenjo', 'Tibacuy', 'Tibirita', 'Tocaima', 'Tocancipá', 'Topaipí',
    'Ubalá', 'Ubaque', 'Ubaté', 'Une', 'Útica', 'Vergara', 'Vianí',
    'Villa de San Diego de Ubaté', 'Villagómez', 'Villapinzón', 'Villeta',
  ...
  'Nariño': [
    ...
    'Leiva', 'Linares', 'Los Andes', 'Magüí Payán', 'Mallama',
    'Mosquera', 'Nariño', 'Olaya Herrera', 'Ospina', 'Pasto', 'Policarpa',
  ...
  'Putumayo': [
    ...
    'Santiago', 'Sibundoy', 'Valle del Guamuéz', 'Villagarzón',
  ],
  'Quindío': [
  ...
  'Santander': [
    ...
    'Jesús María', 'La Belleza', 'La Paz', 'Landázuri', 'Lebríja',
    'Los Santos', 'Macaravita', 'Málaga', 'Matanza', 'Mogotes',
  ...
  'Valle del Cauca': [
    'Alcalá', 'Andalucía', 'Ansermanuevo', 'Argelia', 'Bolívar', 'Buga',
    'Bugalagrande', 'Buenaventura', 'Caicedonia', 'Calima', 'Cali',
...
export const DEPARTAMENTOS: string[] = Object.keys(COLOMBIA).sort()
